...
void switch_sockaddr_set_port(switch_sockaddr_t *sa, switch_port_t port);
...
/*
 * Returns the family, ip and ipv6 address information from sockaddr
 */
...
/*
 * Sets the IPv4 fields of address. addr and port in network order
 */
