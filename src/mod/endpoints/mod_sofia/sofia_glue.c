...
/*static void sofia_glue_set_rtp_event(switch_core_session_t *session, rtp_events_t event); TBR */
...
switch_call_cause_t sofia_glue_sip_cause_to_freeswitch(int status)
{
	...
	case 581:
		return SWITCH_CAUSE_CONFERENCE_INACTIVE;
	default:
...
{
	return switch_core_media_stats_ioctl(session, cmd, arg, SWITCH_MEDIA_TYPE_AUDIO);
}
