...
class Session(CoreSession):
    ...
    def set_digit(self, *args): return _freeswitch.Session_set_digit(self, *args)
    def get_digit(self, *args): return _freeswitch.Session_get_digit(self, *args)
