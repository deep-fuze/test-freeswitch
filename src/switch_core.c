...
/* The main runtime object we keep this hidden for ourselves */
...
#include "cc.h"
    ...
    switch_monitor_init(1500, runtime.memory_pool);
    switch_core_register_api(runtime.memory_pool);
...
{
	switch_mutex_lock(runtime.global_mutex);
	runtime.periodic_log = periodic_log;
	switch_mutex_unlock(runtime.global_mutex);
}
