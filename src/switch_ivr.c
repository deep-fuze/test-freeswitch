...
/*
 * SEND_CNG: this is ifdef'ed out right now as it causes noise during silence periods with call-me calls (fuze/luke)
 *  tbd fix this
 */
...
#if 0
		if (loopcount % 100 == 0) {
			switch_log_printf(SWITCH_CHANNEL_SESSION_LOG(session), SWITCH_LOG_ERROR, "switch_ivr_sleep\n");
		}
		loopcount += 1;
#endif
