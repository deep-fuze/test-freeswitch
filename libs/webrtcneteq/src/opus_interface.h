...
#ifndef OPUS_INTERFACE_H_
#define OPUS_INTERFACE_H_
...
/****************************************************************************
 * WebRtcOpus_AssignDecoder(...)
 *
 * Assign the decoder whose memory is externally managed
 *
 * Input:
 *     - opus_dec_inst         : OPUS instance for decoder
 *     - decoder 	       : OPUS decoder instance
 *     - do_resample	       : whether to downsample from 48 to 32 or not
 * Return value               :  0 - Ok
 *                              -1 - Error
 */
int16_t WebRtcOpus_AssignDecoder(OpusDecInst *opus_dec_inst, void* decoder);
